...
| 제목                                                                                                                                                      | 상태                                                                                                                | 비고                                                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="https://www.facebook.com/images/fb_icon_325x325.png" width="150"><br>Facebook Clone Coding                                                    | 뽀모도로: 약 ??뽀모도리<br>기간: 약 ?일(221026~2210??)<br>언어: 영어<br>                                                           | * Next.js<br> * NextAuth<br> * tailwindCSS <br> * heroIcon <br> * firebase(file upload 부분을 공식 문서를 보며 최신 문법으로 구현.) <br>                                   |
